...
We encourage you to work interactively on this lab (and future assignments) by running code directly in your Console pane. However, you should note that Quarto documents are Rendered in their own unique environment, separate from your interactive session. So you will also need to include the line `library(datasauRus)` inside an R code chunk if you want your document use this package.
